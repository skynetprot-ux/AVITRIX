...
const TopBar: React.FC<TopBarProps> = ({ onToggleSidebar, isSidebarOpen, isDesktop }) => {
    ...
    <div className="top-bar">
      <div className="top-bar-row">
        <div className="top-bar-left">
          <button className="mobile-menu-button" onClick={onToggleSidebar} aria-label="Открыть меню">
            {isSidebarOpen ? '✕' : '☰'}
          </button>
        ...
        <div className="top-bar-right">
          {!isDesktop && (
            <button
              className={`icon-button ${isSearchExpanded ? 'active' : ''}`}
          ...
          {isLoggedIn ? (
            <>
              <button className="nav-button ghost" onClick={() => navigate('/ads')}>
                Мои объявления
              </button>
            ...
            <>
              <button className="nav-button ghost" onClick={handleLogin}>
                Вход
              </button>
      ...
      <div className={`top-bar-search ${isSearchExpanded ? 'expanded' : ''}`}>
